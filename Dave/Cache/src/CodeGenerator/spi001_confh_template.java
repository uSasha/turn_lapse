...
public class spi001_confh_template
{
  ...
  protected final String TEXT_1 = NL + "/*CODE_BLOCK_BEGIN[SPI001_Conf.h]*/" + NL + "/******************************************************************************" + NL + " *" + NL + " * Copyright (C) 2014 Infineon Technologies AG. All rights reserved." + NL + " *" + NL + " * Infineon Technologies AG (Infineon) is supplying this software for use with " + NL + " * Infineon's microcontrollers.  " + NL + " * This file can be freely distributed within development tools that are " + NL + " * supporting such microcontrollers. " + NL + " *" + NL + " * THIS SOFTWARE IS PROVIDED \"AS IS\".  NO WARRANTIES, WHETHER EXPRESS, IMPLIED" + NL + " * OR STATUTORY, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF" + NL + " * MERCHANTABILITY AND FITNESS FOR A PARTICULAR PURPOSE APPLY TO THIS SOFTWARE." + NL + " * INFINEON SHALL NOT, IN ANY CIRCUMSTANCES, BE LIABLE FOR SPECIAL, INCIDENTAL, " + NL + " * OR CONSEQUENTIAL DAMAGES, FOR ANY REASON WHATSOEVER." + NL + " *" + NL + "*******************************************************************************" + NL + "**                                                                           **" + NL + "**                                                                           **" + NL + "** PLATFORM : Infineon XMC4000/ XMC1000 Series                               **" + NL + "**                                                                           **" + NL + "** COMPILER : Compiler Independent                                           **" + NL + "**                                                                           **" + NL + "** AUTHOR   : App Developer                                                  **" + NL + "**                                                                           **" + NL + "** MAY BE CHANGED BY USER [yes/no]: Yes                                      **" + NL + "**                                                                           **" + NL + "** MODIFICATION DATE : Jan 21, 2014                                          **" + NL + "**                                                                           **" + NL + "******************************************************************************/" + NL + " " + NL + "/******************************************************************************" + NL + "**                       Author(s) Identity                                  **" + NL + "*******************************************************************************" + NL + "**                                                                           **" + NL + "** Initials    Name                                                          **" + NL + "** --------------------------------------------------------------------------**" + NL + "** AEP         DAVE App Developer                                            **" + NL + "******************************************************************************/" + NL + "" + NL + "/**";
  protected final String TEXT_2 = NL + " *" + NL + " * @file   SPI001_Conf.h" + NL + " *" + NL + " * @App Version SPI001 <";
  protected final String TEXT_3 = ">" + NL + " *" + NL + " * @brief  Configuration header file generated based on UI settings " + NL + " *         of SPI001 App" + NL + " *" + NL + " */" + NL + "/*" + NL + " * Revision History" + NL + " * 01 Jun 2012 v1.0.0   Initial version" + NL + " * 26 Jul 2012 v1.0.2   Modified to support Quad mode functionalities" + NL + " * 17 Aug 2012 v1.0.4   Macro correction in USIC.h,Fix for OutputEnable for" + NL + " *                      HW controlled pins " + NL + " * 04 Feb 2013 v1.0.12  1. Coding guidelines and MISRA fixes" + NL + " *                      2. Updated for comments and coding guidelines." + NL + " *                      3. Updatd for revision history alignments." + NL + " *                      4. Updated for XMC1000 devices." + NL + " *                      5. Alignment of the revision history " + NL + " * 21 Jan 2014 v1.0.22  1. Added C++ support.                     " + NL + " */" + NL + "" + NL + "#ifndef _CONF_SPI001_H_" + NL + "#define _CONF_SPI001_H_" + NL + "" + NL + "#ifdef __cplusplus" + NL + "extern \"C\" {" + NL + "#endif" + NL + "" + NL + "#include <DAVE3.h>" + NL;
  ...
  protected final String TEXT_17 = NL + NL + "#ifdef __cplusplus" + NL + "}" + NL + "#endif  " + NL + "" + NL + "#endif /* End of _CONF_SPI001_H_ */" + NL + "/*CODE_BLOCK_END*/";
